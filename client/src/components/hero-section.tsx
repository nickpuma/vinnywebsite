    ...
    <section className="relative bg-gradient-to-br from-background via-muted/30 to-background pt-20 pb-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                className="w-full sm:w-auto bg-gradient-to-r from-primary to-accent text-white hover:shadow-xl transition-all duration-300 text-lg px-8 py-4 h-auto"
              >
              ...
              <Button 
                ...
                className="w-full sm:w-auto border-2 border-border text-foreground hover:border-primary hover:text-primary transition-all duration-300 text-lg px-8 py-4 h-auto"
              >
          ...
          >
            {/* Mobile: show a single phone to avoid overflow */}
            <div className="relative z-10 flex justify-center md:hidden">
              ...
              >
                <div className="bg-black rounded-[2rem] w-56 h-[440px] sm:w-64 sm:h-[500px] relative overflow-hidden">
            ...
            {/* Desktop/tablet: show two phones with spacing */}
            <div className="relative z-10 hidden md:flex justify-center space-x-6">
              <motion.div 
                className="bg-gray-900 rounded-[2.5rem] p-2 shadow-2xl"
                animate={{ 
                  rotate: [-3, 0, -3],
