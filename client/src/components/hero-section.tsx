          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="inline-flex items-center justify-center bg-white text-[color:var(--vnny-text-primary)] rounded-full px-8 py-4 text-lg font-medium hover:shadow-xl transition-all duration-300 shadow-lg w-full sm:w-auto"
              >
